...
> use Ubuntu (not Debian), 12GB+ RAM

https://www.ovhcloud.com/en-gb/vps/

> Any (this will be your website)

https://www.namecheap.com

## Setup

> `sudo -i` if you're not a root user from now on
...
```
mv ./server_data_backups/??? ./server/my_server_identity
```
